...
CREATE TABLE IF NOT EXISTS IDN_OAUTH2_ACCESS_TOKEN (
            ...
            FOREIGN KEY (CONSUMER_KEY_ID) REFERENCES IDN_OAUTH_CONSUMER_APPS(ID) ON DELETE CASCADE,
            CONSTRAINT CON_APP_KEY UNIQUE (CONSUMER_KEY_ID,AUTHZ_USER,TENANT_ID,USER_DOMAIN,USER_TYPE,TOKEN_SCOPE_HASH,TOKEN_STATE,TOKEN_STATE_ID,IDP_ID)
...
CREATE TABLE IF NOT EXISTS IDN_OAUTH2_TOKEN_BINDING (
            ...
            TOKEN_BINDING_VALUE VARCHAR (500),
            TENANT_ID INTEGER DEFAULT -1,
